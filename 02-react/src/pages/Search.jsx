...
const useFilters = () => {
    ...
    const [textToFilter, setTextToFilter] = useState(() => {
        const storedText = window.localStorage.getItem('textToFilter')
        if (storedText) {
            return storedText
        }
        const params = new URLSearchParams(window.location.search)
    ...
    useEffect(() => {
        try {
            if (textToFilter) {
                window.localStorage.setItem('jobSearchText', textToFilter)
            } else {
                window.localStorage.removeItem('jobSearchText')
            }
        } catch (error) {
    ...
    useEffect(() => {
        ...
        try {
            window.localStorage.setItem('jobFilters', stringifyFilters)
        } catch (error) {
